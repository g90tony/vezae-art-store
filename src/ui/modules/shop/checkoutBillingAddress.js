  ...
  const validateForm = React.useCallback(
    function () {
      ...
      if (!address1) {
        ...
        newBillingAddress.address1 = address1;
      }
      if (!email) {
        missingData("email");
      } else {
        newBillingAddress.email = email;
      }
      if (!city) {
        missingData("city");
      } else {
      ...
      if (!firstName) {
        ...
        newBillingAddress.firstName = firstName;
      }
      if (!lastName) {
        missingData("lastName");
      } else {
        newBillingAddress.lastName = lastName;
      }
      if (!province) {
        missingData("province");
      } else {
        newBillingAddress.province = province;
      }
      if (!zip) {
        missingData("zip");
      } else {
        newBillingAddress.zip = zip;
      }
